...
本项目是 [Handheld Companion](https://github.com/Valkirie/HandheldCompanion) v0.28.3.3 的 Fork 修改版，主要针对 MSI Claw 设备的指纹按键过于灵敏导致的待机后瞬间唤醒问题，对原 GoBackToSleep 功能进行了适配。
